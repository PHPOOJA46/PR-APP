sap.ui.define(
    ...
    function (Controller, MessageBox, MessageToast, History) {
        ...
        var LineItemNo = "";
        this.LineArr = [];
        return Controller.extend("zprcreate.controller.BaseController", {
